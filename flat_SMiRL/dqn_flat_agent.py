...
#
# Adopt (and simplified for flat input) from following (conv net) DQN code:
# https://github.com/im-ant/gym_RL/blob/control-v1/MiniGrid/dqn_agent.py
#
...
class DQNFlatAgent(object):
    ...
    def _init_memory(self) -> None:
        ...
        self.memory = flat_replay_memory.CircularFlatReplayBuffer(
